...
v_float = 10.0
v_int = 7
v_list = [v_str1, v_str2] #다른 언어에서 배열이라고 함. 
v_dict = {
    "name": "niceman",
    "age": 25
}
v_tuple = 3, 5, 7 #튜플 선언 방법 여러개
v_set = {7, 8, 9} #
...
print(int(c))  # 실수 -> 정수
print(int(d))  # 실수 -> 정수
print(int(True))  # Bool -> 정수  1 이 된다.
print(float(True))  # Bool -> 정수 0이 된다. 
print(int(False))  # Bool -> 정수
print(int("3")) #문자 -> 정수
print(float(False))  # Bool -> 정수
print(complex(3))  # 정수 -> 복소수
print(complex('3'))  # 문자 -> 복소수 
print(complex(False))  # Bool -> 복소수 0 복수소가 나온다. 
