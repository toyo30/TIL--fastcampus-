...
print(type(True))  #이게 불린이다. bool 트루와 펄스인 것으로 참과 거짓을 판별한다. 
print(type(False))
...
if False:   ### ----> False일 때는 스킵하고 넘어감.
    # 출력되지 않음.
    print("No")

# 예2
if False:    ###False일 때는 스킵하고 다음을 실행한다. 
    # 여기는 실행되지 않음.
...
city = "" ####빈 문자열일 때는 거짓이 출력되기 때문에 else로 넘어가서 출력된다. 
if city:
...
city = "Seoul"
if city:
    print("You are in:", city) # 이쪽이 출력된다.
else:
    print("Please enter your city")
